...
export namespace RunService {
  ...
  export async function runScript(
    ...
    const stepsByPackage = new Map<string, ScriptStep[]>();
 ...
 */
function printLegacyExecutingLine(commandName: string, pkgLabel: string, step: ScriptStep, level: LogLevel) {
...
function getScriptSteps(pkg: Package, script: string): ScriptStep[] {
  ...
  const applyConfigScript = (key: string, rawValue: unknown) => {
